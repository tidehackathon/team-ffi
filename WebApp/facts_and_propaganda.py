disinfo = """Classified documents showing Ukraine was preparing an offensive operation against the Donbas;
...
factualinfo = """Russian troops do war crimes in Ukraine;
The annexation of Crimea is an illeagal occupation;
Ukraine is an independant and real country with its own culture and history"""